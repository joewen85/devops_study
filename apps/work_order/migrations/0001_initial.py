    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('orderfiles', models.FileField(blank=True, null=True, upload_to='orderfiles/%Y/%m', verbose_name='附件')),
                ...
                ('handler', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='workorder_handle', to=settings.AUTH_USER_MODEL, verbose_name='最终处理人')),
            ],
            options={
